...
public class ChineseLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(TranslateKeys.BTN_LOAD_PRESET, "加载预设");
        translationBuilder.add(TranslateKeys.BTN_RATES_MODEL, "飞控速率: %s");
        translationBuilder.add(TranslateKeys.BTN_FISHEYE, "鱼眼畸变: %s");
        translationBuilder.add(TranslateKeys.BTN_RELOAD_CONFIG_MENU, "重新加载配置");
        translationBuilder.add(TranslateKeys.BTN_LOAD_RACING_PRESET, "加载：竞速跟拍预设");
