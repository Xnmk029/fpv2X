...
public class EnglishLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(TranslateKeys.BTN_LOAD_PRESET, "Load Presets");
        translationBuilder.add(TranslateKeys.BTN_RATES_MODEL, "Rates Model: %s");
        translationBuilder.add(TranslateKeys.BTN_FISHEYE, "Fisheye Lens: %s");
        translationBuilder.add(TranslateKeys.BTN_RELOAD_CONFIG_MENU, "Reload Configuration");
        translationBuilder.add(TranslateKeys.BTN_LOAD_RACING_PRESET, "Load: Racing / Film Preset");
