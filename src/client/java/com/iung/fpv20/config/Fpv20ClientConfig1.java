...
//    private float camera_angle = 35;
    ...
    private int speedDisplayMode = 1; // 0: OFF, 1: b/s, 2: kb/h
...
//    }
    ...
    public int getSpeedDisplayMode() { return speedDisplayMode; }
    public void setSpeedDisplayMode(int value) { speedDisplayMode = value; }
}
